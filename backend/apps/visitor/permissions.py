...
class IsSecurityOrReceptionAdmin(BasePermission):
    """
    Grants access to Security Admin, Security Officer, Receptionist,
    HR Manager, Principal, and Super Admin roles.
    """
