...
import { ReportingFinalCenter } from "./final/ReportingFinalCenter";
import { ReportingOfflineBanner, ReportingConnectionStatus } from "./final/ReportingOfflineBanner";
import { ReportingErrorBoundary } from "./final/ReportingErrorBoundary";
import { X, Play, LayoutGrid, BarChart3, Wrench, ShieldCheck, Send, Settings } from "lucide-react";
...
export const ReportingLayoutContent: React.FC = () => {
  ...
  const [activeTabMode, setActiveTabMode] = useState<
    "catalog" | "analytics" | "builder" | "executive" | "distribution" | "settings"
  >("catalog");
  ...
  return (
    <ReportingErrorBoundary>
      <div className="flex flex-col h-full min-h-[calc(100vh-4rem)] bg-slate-950 text-slate-100 font-sans">
        {/* Network Offline Awareness Banner */}
        <ReportingOfflineBanner />
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 flex flex-col min-w-0 p-4 sm:p-6 overflow-y-auto">
            ...
            <div className="flex items-center justify-between gap-2 mb-4 flex-wrap">
              <div className="flex items-center gap-2 p-1 bg-slate-900 border border-slate-800 rounded-xl w-fit flex-wrap">
                <button
              ...
              <ReportingConnectionStatus />
            </div>

            {activeTabMode === "settings" ? (
              <ReportingFinalCenter />
            ) : activeTabMode === "distribution" ? (
