...
export const Sidebar: React.FC = () => {
  ...
  const paymentItems = [
    { label: "Payment Dashboard", path: "/payments", icon: LayoutDashboard },
    { label: "Pay Fees Online", path: "/payments/pay", icon: CheckSquare },
    { label: "Payment History", path: "/payments/history", icon: History },
    { label: "Transaction Inspector", path: "/payments/details", icon: FileText },
    { label: "Refund History", path: "/payments/refunds", icon: RefreshCw || FileText },
  ];

  const scholarshipItems = [
    { label: "Scholarship Dashboard", path: "/scholarships", icon: LayoutDashboard },
    { label: "Scholarship Programs", path: "/scholarships/types", icon: Award },
    { label: "Student Scholarships", path: "/scholarships/student", icon: GraduationCap },
    { label: "Applications Roster", path: "/scholarships/applications", icon: FileText },
    { label: "Renewals Tracker", path: "/scholarships/renewals", icon: RefreshCw },
  ...
  const hostelItems = [
    { label: "Hostel Dashboard", path: "/hostel", icon: LayoutDashboard },
    { label: "Hostel Buildings", path: "/hostel/buildings", icon: Building2 },
    { label: "Blocks & Rooms", path: "/hostel/blocks-rooms", icon: Layers },
    { label: "Student Allocations", path: "/hostel/allocations", icon: UserCheck },
    { label: "Visitor Register", path: "/hostel/visitors", icon: Users },
    { label: "Maintenance Tickets", path: "/hostel/maintenance", icon: Settings },
    { label: "Vacancy Report", path: "/hostel/vacancy", icon: BarChart3 },
  ];
